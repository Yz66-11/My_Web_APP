...
description: 美食品鉴Web应用前端设计指南。当用户需要构建美食相关应用、餐厅推荐、食谱展示、美食社区、菜品评价、烹饪教程、美食打卡、探店分享等功能时使用此skill。适用于面向年轻群体的、追求活泼风格与高级质感平衡的美食类前端界面设计。美食品鉴Web应用前端设计指南。当用户需要构建美食相关应用、餐厅推荐、食谱展示、美食社区、 菜品评价、烹饪教程、美食打卡、探店分享等功能时使用此skill。适用于面向年轻群体的、 追求活泼风格与高级质感平衡的美食类前端界面设计。
allowed-tools: 
disable: true
---
